import GoogleMap from "@/components/en/GoogleMap";
import SendMail from "@/components/en/SendMail";
import { Facebook, Instagram, Linkedin, MapPin, Phone } from "lucide-react";
import Image from "next/image";
import Link from "next/link";
import React from "react";
import metadata from "@/lib/metadata/en/iletisim"; // SEO bilgisi burada
  ...
  return (
    <main className="py-20">
      ...
      <section className="flex flex-wrap py-10 md:py-15 px-5 md:px-15">
        ...
        <article className="w-full md:w-2/3 flex justify-center md:justify-end">
