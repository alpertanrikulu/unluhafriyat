      ...
      <div className="flex flex-wrap justify-center md:px-[30px] lg:px-[100px] py-8">
        <div className="w-full md:w-1/2 lg:w-1/3 flex flex-col items-center mb-4">
          <Image
            ...
            height={215}
          />
          <div className="bg-gray-100 max-w-[350px] p-5 h-full flex flex-col justify-between">
        ...
        <div className="w-full md:w-1/2 lg:w-1/3 flex flex-col justify-center items-center mb-4">
          <Image
        ...
        <div className="w-full md:w-1/2 lg:w-1/3 flex flex-col justify-center items-center mb-4">
          ...
          <div className="bg-gray-100 max-w-[350px] p-5 h-full flex flex-col justify-between">
            ...
            <p>
              Yıkım süreci, titizlik ve uzmanlık gerektiren bir iştir. Firmamız,
              küçük ölçekli yapılardan büyük endüstriyel binalara kadar her
              türlü yıkımı, güvenli ve planlı bir şekilde gerçekleştirir. Alanın
              yeniden kullanıma hazır hale gelmesi için gerekli tüm işlemleri
              eksiksiz olarak yürütürüz.
            </p>
            <div className="flex justify-center items-center mt-3">
              <Link
